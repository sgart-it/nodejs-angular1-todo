...
CREATE LOGIN [nodejs] WITH PASSWORD=N'nodejs2015', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO
...
CREATE USER [nodejs] FROM LOGIN [nodejs]
GO

EXEC sp_addrolemember 'db_owner', 'nodejs';
GO
...
CREATE TABLE [dbo].[todos](
	...
	[Date] [date] NOT NULL CONSTRAINT [DF_todos_Date]  DEFAULT (getdate()),
	[Title] [nvarchar](100) NOT NULL,
	[Note] [nvarchar](max) NULL,
	[IDCategory] [int] NOT NULL CONSTRAINT [DF_todos_IDCategory]  DEFAULT ((0)),
	[Completed] [date] NULL,
	[Created] [datetime] NOT NULL CONSTRAINT [DF_todos_Created]  DEFAULT (getdate()),
	[Modified] [datetime] NOT NULL CONSTRAINT [DF_todos_Modified]  DEFAULT (getdate()),
...
CREATE TABLE [dbo].[categories](
	...
	[Color] [nvarchar](10) NOT NULL CONSTRAINT [DF_categories_color]  DEFAULT (''),
